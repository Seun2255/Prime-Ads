      ...
      <animated.div className={styles.content} style={effect}>
        ...
        <div className={styles.details}>
          ...
          <div className={styles.details__item} id={styles.api__details}>
            ...
            make an API call from your frontend using the API copied above, get
            the current user of your Dapps address and replace the 'ETH address
            of the user of your DApp' in the API link with the address . It will
            return 'Referall registered' if succesful.
            {/* e.g. using
