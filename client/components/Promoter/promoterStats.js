...
export default function PromoterStats(props) {
      ...
      <animated.div className={styles.content} style={effect}>
        ...
        <div className={styles.details}>
          <div className={styles.details__item}>
            Referalls: {details.participants[state.user.address].referrals}
          </div>
          <div className={styles.details__item}>
            Amount made:{" "}
            {details.participants[state.user.address].referrals / 10} PRI
          </div>
        </div>
        <button
